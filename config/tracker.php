...
return [
     ...
     */
    'tracker_cookie_name' => 'visit_tracker',

    /*
     * Internal tracker session name.
     */
    'tracker_session_name' => 'visit_tracker_session',
     ...
     * ...
     */
    'user_model' => \Adminx\Common\Models\User::class,

    /*
     * You can use your own model for every single table Tracker has.
     */

    'session_model' => \Adminx\Common\Models\VisitTracker\Session::class,

    'log_model' => \Adminx\Common\Models\VisitTracker\Log::class,

    'path_model' => \Adminx\Common\Models\VisitTracker\Path::class,
    ...
    'cookie_model' => \Adminx\Common\Models\VisitTracker\Cookie::class,
    ...
    'route_model' => \Adminx\Common\Models\VisitTracker\Route::class,

    'route_path_model' => \Adminx\Common\Models\VisitTracker\RoutePath::class,
