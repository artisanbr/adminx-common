...
return [
     ...
     * ...
     */
    'user_model' => \ArtisanBR\Adminx\Common\App\Models\User::class,

    /*
     * You can use your own model for every single table Tracker has.
     */

    'session_model' => \ArtisanBR\Adminx\Common\App\Models\VisitTracker\Session::class,

    'log_model' => \ArtisanBR\Adminx\Common\App\Models\VisitTracker\Log::class,

    'path_model' => \ArtisanBR\Adminx\Common\App\Models\VisitTracker\Path::class,
    ...
    'cookie_model' => \ArtisanBR\Adminx\Common\App\Models\VisitTracker\Cookie::class,
