...
use ArtisanBR\Adminx\Common\App\Facades\FrontendPage;
use ArtisanBR\Adminx\Common\App\Libs\FrontendEngine\FrontendPageEngine;
                ...
                if ($site->theme) {
                    foreach ($site->theme->files()->themeBundleSortened()->values() as $file) {
                        if ($file->extension === 'css') {
                            ...
                            $package->addStyle($file->name, $file->storage_path);
                        }
                        if ($file->extension === 'js') {
                            $package->addScript($file->name, $file->storage_path, ['defer']);
                        }
                    }
                }
            });
