...
class MigrationHelper extends Blueprint {
    ...
    public function setTemplate($name)
    {
        ...
        if (strtolower($classe) == "user") {
            ...
            $template = str_replace('%ExtendsPath%', "use Adminx\Common\Models\ModelBases\EloquentModelBase;", $template);
        }
        return $template;
    }
    ...
    private function template(){
        $template = '<?php
 namespace  Adminx\Common\Models\Properties;
...
namespace Adminx\Common\Models;
 ...
 use Adminx\Common\Models\Properties\%ClassName%Properties;
